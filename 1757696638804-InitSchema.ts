...
export class InitSchema1757696638804 implements MigrationInterface {
    name = 'InitSchema1757696638804'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "super_admin" ADD "role" character varying(250) NOT NULL`);
